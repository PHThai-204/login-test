...
class $AssetsSvgsGen {
  ...
  /// File path: assets/svgs/ic_exit.svg
  SvgGenImage get icExit => const SvgGenImage('assets/svgs/ic_exit.svg');

  /// File path: assets/svgs/ic_eye_close.svg
  SvgGenImage get icEyeClose => const SvgGenImage('assets/svgs/ic_eye_close.svg');
  ...
  /// File path: assets/svgs/ic_search_normal.svg
  SvgGenImage get icSearchNormal => const SvgGenImage('assets/svgs/ic_search_normal.svg');

  /// File path: assets/svgs/ic_social_link.svg
